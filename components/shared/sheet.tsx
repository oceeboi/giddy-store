          ...
          >
            {!hideCloseButton && (
              <button
                ...
                aria-label="Close"
                className="absolute right-4 top-4 inline-flex size-9 items-center justify-center border border-neutral-900 bg-black text-neutral-400 transition-all duration-200 ease-in-out hover:opacity-60 hover:text-white focus-visible:outline-2 focus-visible:outline-white focus-visible:outline-offset-4"
              >
                <CloseIcon />
              </button>
            )}
...
function SheetHeader({
  ...
  return (
    <div className={`border-b border-neutral-900 px-6 pb-4 pt-6 ${className}`}>{children}</div>
  );
}
...
function SheetTitle({
  ...
  return (
    <h2
      id={titleId}
      className={`pr-12 font-archivo text-lg font-black uppercase tracking-widest text-white ${className}`}
    >
      {children}
    </h2>
  );
...
function SheetDescription({
  ...
  return (
    <p
      id={descriptionId}
      className={`mt-2 text-[10px] uppercase tracking-widest text-neutral-500 ${className}`}
    >
      {children}
    </p>
  );
...
function SheetFooter({
  ...
  return (
    <div
      className={`mt-auto flex items-center justify-end gap-2 border-t border-neutral-900 px-6 py-4 ${className}`}
    >
      {children}
    </div>
  );
...
function SheetClose({ asChild, children }: SheetCloseProps) {
  ...
  return (
    <button
      type="button"
      onClick={() => setOpen(false)}
      className="inline-flex items-center justify-center border border-neutral-800 bg-black px-4 py-2 text-[11px] font-bold uppercase tracking-wider text-white transition-all duration-200 ease-in-out hover:text-neutral-400 focus-visible:outline-2 focus-visible:outline-white focus-visible:outline-offset-4"
    >
      {children}
    </button>
  );
