...
interface BreadcrumbProps {
  ...
  // Usage of aliases: { label: 'Home', href: '/' }, { label: 'Shop', href: '/shop' }
  /** Custom home icon or string */
  homeLabel?: React.ReactNode;
  className?: string;
}

export function Breadcrumb({ aliases = {}, homeLabel = 'Home', className }: BreadcrumbProps) {
  ...
  return (
    <nav
      ...
      className={cn('flex py-3 text-sm font-medium text-gray-500', className)}
    >
