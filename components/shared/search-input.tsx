      ...
      <div className={cn('relative w-full')}>
        ...
        <div className="relative flex items-center  w-full">
          <input
            ...
            disabled={disabled}
            className={cn(
              'w-full bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 placeholder-neutral-400 dark:placeholder-neutral-500 border border-neutral-300 dark:border-neutral-700 rounded-none py-2.5 pl-3.5 pr-20 text-sm font-medium transition-colors outline-none focus:border-neutral-900 dark:focus:border-neutral-100 disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-neutral-50 dark:disabled:bg-neutral-950'
            )}
          />
          ...
          <div className="absolute right-2 top-1/2 -translate-y-1/2 flex items-center gap-1 text-neutral-400 dark:text-neutral-500">
            ...
            <button
              ...
              className="p-1.5 hover:bg-neutral-100 dark:hover:bg-neutral-800 rounded-none transition-colors"
              type="button"
              tabIndex={-1}
              disabled={disabled}
            >
        ...
        {isOpen && !disabled && (
          <div
            className="absolute z-50 w-full mt-1 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-none shadow-lg overflow-y-auto"
            style={{ maxHeight }}
          >
