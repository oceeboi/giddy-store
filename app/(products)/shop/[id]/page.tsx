...
// Sample mock data matching the ProductColor type
const MOCK_COLORS: ProductColor[] = [
  { id: '1', name: 'black', hexCode: '#000000' },
  { id: '2', name: 'shadow stripe', hexCode: '#1c1c1c' },
  { id: '3', name: 'neutral grey', hexCode: '#7F7F7F' },
];
...
export default function ShoppingProductDetailsPage() {
  const { control, handleSubmit, setValue } = useForm<ProductCatalog>({
    resolver: zodResolver(productCatalog),
    defaultValues: {
      id: 'prod_123',
      colorId: '1',
      sizeId: '1',
  ...
  useEffect(() => {
    const variantsForColor = MOCK_VARIANTS.filter((v) => v.colorId === selectedColorId);
  ...
  function handleAddToCart(data: ProductCatalog) {
    console.log('Add to Cart:', data);
  }

  const consusmerServiceFeatures: { title: string; description: string; icon: JSX.Element }[] = [
    {
      ...
      icon: (
        ...
        >
          <g clipPath="url(#clip0_1938_10574)">
            <path
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clipPath="url(#clip0_1938_10581)">
            <path
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clipPath="url(#clip0_1415_19004)">
            <path
    ...
    },
    {
      ...
      icon: (
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
        >
          <g clipPath="url(#clip0_1938_10588)">
            <path
  ...
  return (
    <section>
        ...
        <div>
          <section className="pt-6 pb-12 px-4 lg:pt-15 lg:px-30">
            ...
            <form className="flex flex-col gap-4" onSubmit={handleSubmit(handleAddToCart)}>
              <ProductColorSelector control={control} name="colorId" colors={MOCK_COLORS} />
              <ProductSizeSelector
                control={control}
                name="sizeId"
              ...
              <button type="button" className="flex flex-col gap-1 items-start">
                <p className="text-sm text-neutral-500 font-archivo capitalize">size & fit guide</p>
              </button>
              ...
              <div className="flex flex-col gap-3 mt-6">
                ...
                <button
                  type="button"
                  className="w-full border-[0.5px] uppercase border-black bg-white text-black py-3 px-4 rounded-none text-base font-archivo font-medium tracking-tight transition-all duration-200 ease-in-out hover:bg-neutral-900/30 hover:text-white focus-visible:outline focus-visible:outline-black focus-visible:outline-offset-2"
                >
                  Add to Wishlist
                </button>
              </div>
                ...
                <Accordion.Content className="p-4 bg-white text-black font-archivo font-normal tracking-tight text-sm">
                  <p className="mb-4">
                    <span className="text-base text-[#787878] font-archivo font-normal tracking-tight">
                      Understated yet futuristic, this oversized T-shirt features a small, glossy 3D
                      metallic Ashluxe logo and wordmark. Designed for daily sophistication with
                      quiet shine, it's cut from smooth mid-weight cotton jersey for a sleek
                      streetwear profile.
                    </span>
                  </p>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1.5">
                      <li className="flex items-center gap-1.5 lg:gap-3">
                        <span className="w-1.5 h-1.5 lg:w-2 lg:h-2  rounded-full bg-[#787878] shrink-0"></span>
                        <span className="text-sm lg:text-base text-[#787878] font-archivo font-normal tracking-tight">
                          Mid-weight single cotton jersey
                        </span>
                      </li>
                      <li className="flex items-center gap-1.5 lg:gap-3">
                        <span className="w-1.5 h-1.5 lg:w-2 lg:h-2 rounded-full bg-[#787878] shrink-0"></span>
                      ...
                      <li className="flex items-center gap-1.5 lg:gap-3">
                        <span className="w-1.5 h-1.5 lg:w-2 lg:h-2 rounded-full bg-[#787878] shrink-0"></span>
                        <span className="text-sm lg:text-base text-[#787878] font-archivo font-normal tracking-tight">
                          Small 3D glossy metallic logo & wordmark
                        </span>
                      </li>
                    </ul>
                  </div>
                  <div>
                    <h4 className="mt-4 mb-2">
                      <strong className="lg:text-base text-sm text-[#787878] capitalize font-archivo font-medium tracking-tight">
                        Model Sizing: Model is wearing size "M"
                      </strong>
                    </h4>
                    <ul className="space-y-1.5">
                      <li className="flex items-center gap-1.5 lg:gap-3">
                        <span className="w-1.5 h-1.5 lg:w-3 lg:h-3 rounded-full bg-[#787878] shrink-0"></span>
                        <span className="lg:text-base text-sm text-[#787878] font-archivo font-normal tracking-tight">
                          Height: 6'2
                        </span>
                      </li>
                      <li className="flex items-center gap-1.5 lg:gap-3">
              ...
              <Accordion.Item value="product-specifications">
                ...
                <Accordion.Content className="p-4 bg-white text-black font-archivo font-normal tracking-tight text-sm">
                  <div className="flex flex-col gap-2">
                    <p>
                      <span className="text-[#787878] font-archivo uppercase">
                        Made In Portugal
                      </span>
                    </p>
                    <p>
                      <span className="text-[#787878] font-archivo uppercase">100% Cotton </span>
                    </p>
                  </div>
                </Accordion.Content>
              </Accordion.Item>
            ...
            <Accordion>
              <Accordion.Item value="product-specifications">
                ...
                <Accordion.Content className="p-4 bg-white text-black font-archivo font-normal tracking-tight text-sm">
                  <div className="flex flex-col gap-2">
                    <p>
                      <span className="text-[#787878] font-archivo uppercase"></span>
                    </p>
                  </div>
                </Accordion.Content>
              </Accordion.Item>
      ...
      <section className="lg:py-20 flex flex-col gap-10 lg:gap-20 py-10 ">
        <div className="px-4">
          ...
          <div className="flex overflow-x-auto w-full gap-4 pb-2 scroll-smooth [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] scrollbar-none">
            <span className="sr-only">You may also like(similar products no deep algorithm)</span>
        ...
        <div className="px-4">
          ...
          <div className="flex overflow-x-auto w-full gap-4 pb-2 scroll-smooth [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] scrollbar-none3">
            <span className="sr-only">Recently viewed products</span>
      ...
      <section className="py-14 px-4">
        <span className="sr-only">Customer service features</span>
        <div
          className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 w-full"
          style={{ gap: '50px' }}
        >
          {consusmerServiceFeatures.map((feature, index) => (
            <div key={index} className="flex flex-col gap-4 items-start justify-start">
              {feature.icon}
              <h1 className="text-base font-archivo capitalize">{feature.title}</h1>
