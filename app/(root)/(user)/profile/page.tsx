...
export default function () {
  const { data: user_info, isLoading: is_user_loading, isError, error } = useUserQuery();
  ...
  if (is_user_loading) {
    return (
      <section className="flex flex-col gap-6 animate-pulse">
        ...
        <section className="rounded-none border bg-white/90 p-8 sm:p-8">
          <div className="mb-6 flex flex-col gap-2">
            <div className="h-7 w-32 bg-neutral-200 dark:bg-neutral-800" />
            <div className="h-4 w-60 bg-neutral-200 dark:bg-neutral-800" />
          </div>
          ...
          <div className="space-y-5.75">
            ...
            <div className="grid gap-5 lg:grid-cols-2">
              <div className="space-y-2">
                <div className="h-4 w-20 bg-neutral-200 dark:bg-neutral-800" />
                <div className="h-11 w-full bg-neutral-100 dark:bg-neutral-900/40 border border-neutral-200 dark:border-neutral-800" />
              </div>
              <div className="space-y-2">
                <div className="h-4 w-28 bg-neutral-200 dark:bg-neutral-800" />
            ...
            {/* SingleMediaUpload Skeleton */}
            <div className="h-32 w-full rounded-none border border-dashed border-neutral-300 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900/20 flex flex-col items-center justify-center gap-2">
            ...
            <div className="grid gap-5 lg:max-w-md space-y-2">
              <div className="h-4 w-20 bg-neutral-200 dark:bg-neutral-800" />
              <div className="h-11 w-full bg-neutral-100 dark:bg-neutral-900/40 border border-neutral-200 dark:border-neutral-800" />
            </div>

            {/* Update Button Skeleton */}
            <div className="h-[48px] w-full bg-neutral-300 dark:bg-neutral-800 rounded-none" />
          </div>
        </section>
        ...
        <section className="rounded-none border bg-white/90 p-8 sm:p-8">
          <div className="mb-6 flex flex-col gap-2">
            <div className="h-7 w-28 bg-neutral-200 dark:bg-neutral-800" />
            <div className="h-4 w-72 bg-neutral-200 dark:bg-neutral-800" />
          </div>
  ...
  return (
    <section className="flex flex-col gap-6">
      <section className="rounded-none border  bg-white/90 p-8  sm:p-8">
        <div className="mb-6 flex flex-col gap-2">
          <h3 className="text-[24px] uppercase font-archivo-black font-medium text-[#821E2A]">
            Profile
          </h3>
          <p className="text-sm font-archivo text-neutral-500">Update your profile information.</p>
        </div>

        <form
          onSubmit={user_update_form.handleSubmit(user_update_on_submit)}
          className="space-y-5.75 font-archivo"
        >
          <div className="grid gap-5 lg:grid-cols-2">
            <Field
              label="First Name"
          ...
          <button
            ...
            className="rounded-none w-full cursor-pointer bg-[#1d2128] px-7 py-3.5 text-white transition-opacity disabled:cursor-not-allowed disabled:opacity-60"
          >
            <p className="text-sm font-bold">Update Changes</p>
          </button>
        </form>
      </section>
      <section className="rounded-none border font-archivo  bg-white/90 p-8  sm:p-8">
        <div className="mb-6 flex flex-col gap-2">
