...
export default function BillingAddressPage() {
  ...
  return (
    <div className="p-8 border rounded-none font-archivo">
      <Breadcrumb />
      <div>
        <h3 className="my-5 text-[24px] font-medium text-black">Billing address</h3>
      </div>
          ...
          <div className="mt-5">
            <Field label="Street address" error={errors.street?.message} delay={100} xx={true}>
              <Input
                ...
                type="text"
                className="rounded-none"
                placeholder="e.g. 12 Long Street, City Centre"
          ...
          <div className="mt-5">
            <Field label="Town / City" error={errors.city?.message} delay={100} xx={true}>
              <Input
                {...register('city')}
                type="text"
                placeholder="e.g. Cape Town or Johannesburg"
          ...
          <div className="my-5">
            <Field label="Address Label" error={errors.label?.message} delay={100} xx={false}>
              <Input
                {...register('label')}
                type="text"
                placeholder="e.g. Home, Work, Head Office"
                autoComplete="off"
                className="rounded-none"
