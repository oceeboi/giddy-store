...
import { features, productColumns } from '@/components/columns/admin/product-column';
import { ProductRowCard } from '@/components/comps';
import { useAdminProductsListQuery } from '@/hooks/use-product.hook';
import { flexRender, useTable } from '@tanstack/react-table';
import { useTanStackTableDevtools } from '@tanstack/react-table-devtools';

export default function AdminProductPage() {
  const { data, isLoading, isError, error } = useAdminProductsListQuery();
